 ...
 */
@Slf4j
public class SparkSubmitEncryptShuffleMain {
    ...
    public static void main(String[] args) {
        ...
        int sshPort = 22;
        final String command = String.format("sh /home/data_tool/bd-spark/bd-spark-encrypt-shuffle/runSparkEncryptShuffleJob.sh '-c %s' '%s'",
                jsonParam, jobName);
