...
// */
//@Slf4j
//public class SparkSubmitEncryptEcOmsOrderCustomOnlineAftereTest {
...
//        config.setCustomExtractWhereSql(" a.last_update_time >= '2019-01-01 00:00:00' and a.last_update_time < '2020-01-01 00:00:00' and a.address is null");
////        config.setCustomExtractWhereSql("last_update_time >= '2019-01-01 00:00:00' and last_update_time < '2022-01-01 00:00:00' and address is null");
////        config.setCustomExtractWhereSql("last_update_time >= '2019-01-01 00:00:00' and last_update_time < '2022-01-01 00:00:00' and address is null");
