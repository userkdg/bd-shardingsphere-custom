...
public final class DataMaskingEncryptAlgorithmTest {
    ...
    public void setUp() {
        ...
        encryptAlgorithm = ShardingSphereAlgorithmFactory
                .createAlgorithm(new ShardingSphereAlgorithmConfiguration("DATA_MASKING", props),
                        EncryptAlgorithm.class);
    }

    @Test
    public void assertEncrypt() {
        assertThat(encryptAlgorithm.encrypt("18813975053"), is("18813975053"));
        ...
        assertThat(encryptAlgorithm.decrypt("18813975053"), is("188****5053"));
    ...
    public void assertDecrypt() {
        assertThat(encryptAlgorithm.decrypt("18813975053").toString(), is("188****5053"));
    }
