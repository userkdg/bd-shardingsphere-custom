...
public class SM4EncryptAlgorithmTest {
    ...
    public void setUp() {
        ...
        props.setProperty("sm4-key-value", "abc123efg");
    ...
    public void assertEncrypt() {
        assertThat(encryptAlgorithm.encrypt("18813975053"), is("Ztb20zufXcItdTCVqk+30w=="));
        assertThat(encryptAlgorithm.encrypt(null), is(nullValue()));

        assertThat(encryptAlgorithm.decrypt("Ztb20zufXcItdTCVqk+30w=="), is("18813975053"));
