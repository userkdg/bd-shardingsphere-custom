...
@Setter
@Getter
public final class DataMaskingEncryptV2Algorithm implements EncryptAlgorithm {

    private static final String DATA_MASKING_TYPE = "data_masking_type";

    private static final String DATA_MASKING_NAME = "DATA_MASKING_V2";
    ...
    public String encrypt(final Object plaintext) {
        ...
        return DesensitizedUtil.desensitized(plainTextStr, type);
    }
